...
If I need Claude to generate a new feature, it must operate within the strict definitions of my existing template. This is the exact configuration block I feed into the agent's system prompt to stop it from going rogue and introducing breaking inconsistencies.
