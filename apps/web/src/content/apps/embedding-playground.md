...
personalUse: "When I build a retrieval or dedup step, my mental model of 'these two sentences are similar' rarely matches what the embedding model thinks. I wanted a scratchpad where I could drop in a few real examples and instantly see the cosine numbers and the cluster shape, so I stop guessing at thresholds and start reading them off an actual heatmap."
status: "active"
