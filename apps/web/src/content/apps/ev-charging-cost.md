...
personalUse: "I charge my Model Y mostly at home but use Superchargers on long trips. The blended cost per mile is hard to intuit because Supercharging runs 2-4× my home rate, so a few road trips quietly move the average. This gives me the actual number I should use when comparing against renting an ICE for a trip."
status: "active"
